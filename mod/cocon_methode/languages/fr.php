<?php
$language = array (
	'cocon_methode' => "Kit Méthode Cocon",
	
	'cocon_methode:error:requiredetab' => "Pour utiliser ce kit, votre compte doit être rattaché à un établissement.",
	'cocon_methode:editprofile' => "Veuillez choisir votre établissement en complétant les informations de votre profil sur cette page",
	
	'cocon_methode:group:created' => "Le groupe de votre établissement a bien été créé.",
	'cocon_methode:group:joined' => "Vous avez été inscrit dans le groupe de votre établissement : %s",
	...
	Si cette information est erronée ou n'est plus à jour, veuillez le signaler à l'équipe du site :  %5\$s
