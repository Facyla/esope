...
<p>
	...
	<a href="<?php echo elgg_get_site_url(); ?>ical_viewer/" target="_new" class="elgg-button elgg-button-action">&rarr;&nbsp;Afficher l'agenda public dans une nouvelle fenêtre</a>
</p>
