...
<p>
	<fieldset style="border: 1px solid; padding: 15px; margin: 0 10px 0 10px">
		...
		<?php echo elgg_view('input/select', array('name' => 'params[cas_library]', 'options_values' => array('1.3.2' => 'phpCAS-1.3.2', '1.3.3' => 'phpCAS-1.3.3', '1.3.4' => 'phpCAS-1.3.4'), 'value' => $vars['entity']->cas_library)); ?><br/>
