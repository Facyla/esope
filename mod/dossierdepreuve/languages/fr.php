...
$french = array(
	...
	'dossierdepreuve:referentiel:infotype' => "Si vous souhaitez un positionnement complet, vous devez répondre à toutes les questions de tous les domaines.<br />Vous pouvez répondre dans l'ordre de votre choix, et modifier vos réponses autant que vous le souhaitez. Pour changer de domaine, utilisez les flèches ou cliquez sur l'onglet correspondant au domaine de votre choix.<br /><br />Vous pouvez faire une auto-évaluation partielle, en ne répondant qu'aux questions correspondant aux compétences et aux domaines de votre choix.<br /><br />Prenez votre temps et répondez le plus sincérement possible aux questions.<br /><br />Quand vous avez terminé, cliquez sur le bouton \"Enregistrer mes réponses et afficher les résultats\" tout en bas du questionnaire.<br />",
	...
	'dossierdepreuve:results:title' => "Résultats du test de positionnement",
	...
	'dossierdepreuve:results:done' => "Ce questionnaire d'auto-positionnement est maintenant terminé.",
	...
	'dossierdepreuve:report:totalanswered' => "Vous avez répondu à %s des %s questions de ce test d'auto-positionnement.<br />",
	...
	// Mails & messages
	'dossierdepreuve:msg:subject' => "Test d'auto-positionnement B2i adultes",
	'dossierdepreuve:msg:message' => "Vous venez de terminer votre questionnaire d'auto-positionnement de la plateforme des Compétences Numériques.<br />Comme vous l'avez demandé, voici les résultats de votre test. Ceux-ci ne sont pas conservés sur la plateforme et restent anonymes.<br />Si vous le souhaitez, vous pouvez utiliser ou transmettre à votre formateur le code présent en fin de mail pour reprendre votre questionnaire dans l'état où vous l'aviez laissé.",
	'dossierdepreuve:msg:restoredata' => "Données à utiliser pour restaurer votre auto-positionnement sur le site, ou mettre à jour votre dossier de preuve avec ces informations :",
	...
	'dossierdepreuve:auto:description' => "Ce test permet de savoir où vous en êtes par rapport au référentiel national de compétences B2i adultes. En répondant aux questions, auto-évaluez vos compétences numériques et identifiez ainsi vos axes d'amélioration.<br /><br />Utilisez ce test librement, renseignez-le en totalité ou pas, et recevez vos résultats par mail si vous le souhaitez.<br /><br />Le temps moyen de réponse à l'ensemble du questionnaire est de 15 minutes.",
	'dossierdepreuve:auto:contact_email' => "Votre adresse email",
	'dossierdepreuve:auto:contact_email:help' => "Facultatif, uniquement si vous souhaitez recevoir vos résultats par mail.<br /><em>Note&nbsp;: vous pouvez envoyer les résultats à plusieurs adresses email, en les séparant par des virgules ou des espaces, par ex.: \"mail@service.fr mail2@autreservice.com\")</em>",
	'dossierdepreuve:auto_type' => "Choix du test d'auto-positionnement",
	...
	'dossierdepreuve:auto_type:full' => "Auto-positionnement complet (fiable, 15 à 30 minutes)",
	'dossierdepreuve:auto_type:random' => "Auto-positionnement rapide (approximatif, 1 question au hasard par compétence)",
	'dossierdepreuve:auto_type:limited' => "Auto-positionnement limité (choix des domaines à autoévaluer)",
	...
	'dossierdepreuve:auto_type:restore_history' => "Restauration d'un questionnaire d'auto-positionnement précédent",
	...
	'dossierdepreuve:currentautopositionnement' => "Votre auto-positionnement actuel&nbsp;: ",
