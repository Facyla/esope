...
return array(
	...
	'groups:content_access_mode:warning' => "Attention : la modification de ce paramètre ne changera pas le niveau d'accès des contenus déjà publiés dans le groupe !",
	...
	'groups:permissions:error' => 'Vous n\'avez pas les droits pour ça',
...
'%s a ajouté un nouveau sujet de discussion dans le groupe %s :

Titre : %s

%s

Afficher le sujet de discussion et y répondre :
%s
',
...
Afficher la discussion et y répondre :
%s
',
	...
	'groupforumtopic:new' => "Ajouter un sujet de discussion",
	...
	'discussion:error:missing' => 'Les champs "Titre" et "Message de la discussion" sont obligatoires',
	'discussion:error:permissions' => 'Vous n\'avez pas l\'autorisation d\'effectuer cette action',
	'discussion:error:notdeleted' => 'Impossible de supprimer le sujet de discussion',

	'discussion:reply:edit' => 'Modifier la réponse',
	'discussion:reply:deleted' => 'La réponse au sujet de discussion a été supprimée.',
	'discussion:reply:error:notfound' => 'La réponse à ce sujet de discussion n\'a pas été trouvée',
	'discussion:reply:error:notfound_fallback' => "Désolé, la réponse demandée n'a pas été trouvée. Vous avez été redirigé vers le sujet de discussion original.",
	'discussion:reply:error:notdeleted' => 'Impossible de supprimer la réponse au sujet de discussion',

	'discussion:search:title' => 'Répondre au sujet de discussion : %s',
	...
	'groups:addtopic' => 'Ajouter un sujet de discussion',
	...
	'groups:topicmessage' => 'Message de la discussion',
	...
	'groups:when' => 'Quand',
	'grouptopic:notcreated' => 'Aucun sujet de discussion n\'a encore été créé.',
	'groups:topicclosed' => 'Fermé',
	'grouptopic:created' => 'Votre sujet de discussion a bien été créé.',
	'groups:topicsticky' => 'Sujet épinglé',
	'groups:topicisclosed' => 'Ce sujet de discussion sujet est fermé.',
	'groups:topiccloseddesc' => 'Ce sujet de discussion a été fermé et n\'accepte plus de nouveaux commentaires.',
	'grouptopic:error' => 'Votre sujet de discussion n\'a pas pu être créé. Merci de réessayer ou de contacter un administrateur du site.',
	'groups:forumpost:edited' => "La modification du message a bien été effectuée.",
	'groups:forumpost:error' => "Il y a eu un problème lors de la modification du message.",
...
%s",
	...
	'river:create:object:groupforumtopic' => '%s a démarré un nouveau sujet de discussion %s',
	'river:reply:object:groupforumtopic' => '%s a répondu dans le sujet de discussion %s',
	...
	'groups:forumtopic:edited' => 'Le sujet de discussion bien été modifié.',
	...
	'grouppost:deleted' => 'La publication dans le groupe a été supprimée',
	'grouppost:notdeleted' => 'La publication dans le groupe n\'a pas pu être supprimée',
	'groupstopic:deleted' => 'Sujet de discussion supprimé.',
	'groupstopic:notdeleted' => 'Le sujet de discussion n\'a pas pu être supprimé',
	'grouptopic:blank' => 'Pas de sujet de discussion',
	'grouptopic:notfound' => 'Le sujet de discussion n\'a pas pu être trouvé',
	'grouppost:nopost' => 'Aucune publication',
	 ...
	 * ecml
	 */
	'groups:ecml:discussion' => 'Discussions du groupe',
