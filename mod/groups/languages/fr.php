...
return array(
	...
	'discussion:topic:notify:body' => '%s a ajouté un nouveau sujet de discussion dans le groupe %s :
...
',
	...
	'discussion:reply:notify:body' => '%s a répondu au sujet de discussion %s dans le groupe %s :
