...
$site_url_text = '<img src="' . $vars['url'] . 'mod/theme_fing/graphics/fing/accueil_fing.png" alt="' . $vars["config"]->site->name . '">';
$site_url = elgg_view("output/url", array("href" => $vars["config"]->site->url, "text" => $site_url_text, 'title' => $vars["config"]->site->name));
	...
	<body>
		...
		<div id="notification_container">
			...
			<div id="notification_footer">
				<img id="notification_footer_logo" src="<?php echo $vars['url']; ?>mod/theme_fing/graphics/fing/fing_white_footer.png" alt="FING" />
				<?php
