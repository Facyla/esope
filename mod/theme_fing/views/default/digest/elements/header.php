...
echo "<h1>";
if (!empty($group)) {
	echo elgg_echo("theme_fing:digest:message:title:group", array(elgg_echo("digest:interval:" . $interval), $group->name, $site->name));
} else {
	echo elgg_echo("theme_fing:digest:message:title:site", array(elgg_echo("digest:interval:" . $interval), $site->name));
}
echo "</h1>";
