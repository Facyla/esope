...
?>
<div id="prevent_notification" style="background: none repeat scroll 0 0 #CCC; border-radius: 6px 6px 6px 6px; padding: 6px;">
  <img src="<?php echo $vars['url']; ?>mod/prevent_notifications/graphics/notify.png" style="float:left; margin-right:12px; height:40px;"/>
