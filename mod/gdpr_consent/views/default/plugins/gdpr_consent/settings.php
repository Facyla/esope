...
/*
Plugin de recueil de la validation explicite de la Charte d'utilisation : permettre de recueillir le consentement a posteriori pour les comptes créés précédemment et qui avaient pu être créés sans les valider, ou pour valider une nouvelle version.
...
echo '<div><label>' . elgg_echo('gdpr_consent:settings:consent_config') . ' ' . elgg_view('input/plaintext', ['name' => 'params[consent_config]', 'value' => $plugin->consent_config]) . '</label></div>';
