...
echo '<div class="knowledge_database-edit-field">';
	...
	echo '<form id="kdb-define-field-form" action="javascript:kdb_define_field();" method="POST">';
		...
		echo '<p>';
			...
			echo '<label>' . elgg_echo('knowledge_database:settings:field:type') . ' ' . elgg_view('input/select', array('name' => 'type', 'value' => $config['type'], 'options_values' => $field_type_opt)) . '</label> &nbsp; ';
