...
echo '<div style="width:83%; float:left;">';
	echo elgg_view('input/plaintext', array(
		...
		'class' => 'mtm',
		'id' => 'thewire-textarea',
		'placeholder' => elgg_echo('adf_platform:homewire:msg'),
	));
echo '</div>';
...
echo '<div style="width:16%; float:right;">';
	...
	if ($post) {
		...
		if (empty($default_access) || ($default_access == 'default') || !is_int($default_access+2)) { $default_access = get_default_access(); }
