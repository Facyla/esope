 ...
 */
require_once $cmis_lib_path . 'PccHTML.php';
...
$soap_url = elgg_get_plugin_setting('cmis_soap_url', 'elgg_cmis');
$url = $cmis_url . $soap_url;
//$url = 'https://partage.inria.fr:443/alfresco/cmisws/RepositoryService?wsdl';
//$url = 'http://partage.inria.fr/alfresco/cmisws/';
//$url = 'https://partage.inria.fr/alfresco/cmisws/';
...
function createModalDialog($html, $name, $title) {
	echo $html->applyTemplate('modalDialog', $name, $title, $html->applyTemplate($name . 'Dialog', $name));
}
