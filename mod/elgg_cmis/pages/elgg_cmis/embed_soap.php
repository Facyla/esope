 ...
 */
require_once 'embed_PccHTML.php';
...
$maxItems = 30;     // max number of documents on a page
//$useQuery = true;  // get document list with query, or with getChildren
$useQuery = false;  // On n'a que les docs publics via une query !!
