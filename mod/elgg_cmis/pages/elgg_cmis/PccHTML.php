...
// recursive brackets are allowed
    ...
    private static $templates = array(
        // HTML Code sniplets
        'folderUrl' => '<a href="cmis?folderid={$1}">{$2}</a>',
        ...
        'docListEntry' => '<tr><td><a href="cmis?action=download&objectid={$1}">{$2}</a></td><td>{$3}</td><td align="right">{$4}</td></tr>',
        'docListEmpty' => "<tr><td>No documents in this folder</td></tr>\n",
        'pageLink' => '&nbsp;<a href="cmis?folderid={$1}&page={$2}">{$2}</a>&nbsp;',
        'pageCurrent' => '&nbsp;<b>{$1}</b>&nbsp;',
        'pageList' => '<div class="paging">{$1}</div>',
        'downloadFrame' => '<iframe width="1" height="1" frameborder="0" src="cmis?action=download&objectid={$1}"></iframe>',
        ...
        'detailsAction' => '<a href="cmis?action=details&objectid={$1}">More</a>&nbsp;',
...
,       'uploadFileDialog' => <<<EOF
    Select file to upload for document<div class="dialognotice"></div>
                <form id="{\$1}Form" method="POST" ENCTYPE="multipart/form-data" action="cmis">
                    <table><tbody><tr>
                        <td>File Name:</td><td>
...
,       'cancelCODialog' => <<<EOF
    Confirm Cancel Check-out for document<div class="dialognotice"></div>Unsaved changes will be lost!
                <form id="{\$1}Form" method="GET" action="cmis">
        ...
        <div class="header">
            <div class="titleContainer">
                ...
                <div class="logoutTitle">
                    <a href="cmis?action=logout">Logout</a>
                </div>
            </div>
            {\$1}
