...
$fr = array(
	...
	/* Usersettings */
	'elgg_cmis:details' => "Ce panneau de configuration vous permet de  pouvoir accéder facilement à vos données sur Partage en pré-enregistrant votre mot de passe Partage. Il vous sera utile dans deux cas :<ul>
	<li>l'accès direct à vos fichiers  sous Partage via le tableau de bord de la page d'accueil \"Mes fichiers sous Partage\"</li>
	<li>l'accès direct à un répertoire dédié sous Partage via un groupe, lorsque le responsable du groupe l'a prévu.</li>
</ul>
