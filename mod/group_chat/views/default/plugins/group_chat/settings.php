...
echo '<p><label>' . elgg_echo('group_chat:settings:group_chat') .' '. elgg_view('input/select', array('name' => 'params[group_chat]', 'options_values' => $groupchat_options, 'value' => $vars['entity']->group_chat));
echo '</label></p>';
...
echo '<p><label>' . elgg_echo('group_chat:settings:notifications') .' '. elgg_view('input/select', array('name' => 'params[group_notification]', 'options_values' => $no_yes_opt, 'value' => $vars['entity']->group_notification));
echo '</fieldset>';


// Site chat
echo '<fieldset><legend>' . elgg_echo('group_chat:settings:site_chat') .'</legend>';
echo '<p><label>' . elgg_echo('group_chat:settings:site_chat') .' '. elgg_view('input/select', array('name' => 'params[site_chat]', 'options_values' => $no_yes_opt, 'value' => $vars['entity']->site_chat));
echo '</label></p>';
...
echo '<p><label>' . elgg_echo('group_chat:settings:notifications') .' '. elgg_view('input/select', array('name' => 'params[site_notification]', 'options_values' => $no_yes_opt, 'value' => $vars['entity']->site_notification));
echo '</fieldset>';

// User chat
echo '<fieldset><legend>' . elgg_echo('group_chat:settings:user_chat') .'</legend>';
echo '<p><label>' . elgg_echo('group_chat:settings:user_chat') .' '. elgg_view('input/select', array('name' => 'params[user_chat]', 'options_values' => $no_yes_opt, 'value' => $vars['entity']->user_chat));
echo '</label></p>';
...
echo '<p><label>' . elgg_echo('group_chat:settings:notifications') .' '. elgg_view('input/select', array('name' => 'params[user_notification]', 'options_values' => $no_yes_opt, 'value' => $vars['entity']->user_notification));
echo '</fieldset>';
