...
$fr = array(
	...
	'hybridauth:availableusername' => "Le nom d'utilisateur %s est disponible sur ce site.<br />Si vous n'avez pas encore de compte, vous pouvez utiliser ce nom d'utilisateur pour vous inscrire.",
	...
	'hybridauth:revokeassociation:details' => "Souhaitez-vous révoquer votre accès avec %s ? Si vous faites cela, vous ne pourrez plus vous connecter avec ce service.<br /><em>Note : vous pourrez mettre en place une nouvelle association avec %s à tout moment.</em>",
	'hybridauth:association:ok' => "<strong>Le compte %s (%s) est associé avec votre compte %s.</strong> Vous pouvez vous connecter avec %s.",
