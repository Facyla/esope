...
$en = array(
	...
	'hybridauth:availableusername' => "The username %s is available on this site.<br />If you do not have any account yet, you may use this username to register.",
	...
	'hybridauth:revokeassociation:details' => "Do you want to revoke access with %s ? If you do this, you won't be able to connect with this service anymore.<br /><em>Note : you will be able to enable a new %s association at any time.</em>",
	'hybridauth:association:ok' => "<strong>Account %s (%s) is associated with your account %s.</strong> You can login with %s.",
