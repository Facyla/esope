...
if (elgg_get_plugin_setting('hidden_groups', 'groups') == 'yes') {
	...
	if (elgg_is_active_plugin('access_collections')) {
		$visibility_options = access_collections_add_custom_collections_options($visibility_options);
	}
	echo elgg_view_field([
		'#type' => 'access',
...
if ($show_content_default_access) {
	...
	if (elgg_is_active_plugin('access_collections')) {
		$content_default_access_options = access_collections_add_custom_collections_options($content_default_access_options);
	}
