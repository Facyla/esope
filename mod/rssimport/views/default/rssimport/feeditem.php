...
$checkboxclass = "rssimport-checkbox-active";
...
if ($blacklisted) {
	...
	$checkboxclass = "rssimport-checkbox-disabled";
}
...
if (strlen($content) > 800) {
  $excerpt = elgg_get_excerpt($content, 800);
	$excerpt .= "<br>" . elgg_view('output/url', array('text' => elgg_echo('rssimport:more'), 'class' => 'rssimport-excerpt-toggle', 'rel' => $itemid)) . "<br><br>"; //"<br> (<a href=\"javascript:rssimportToggleExcerpt('$itemid');\">" . elgg_echo('rssimport:more') . "</a>)<br><br>";
	$content .= "<br>" . elgg_view('output/url', array('text' => elgg_echo('rssimport:less'), 'class' => 'rssimport-excerpt-toggle', 'rel' => $itemid)) . "<br><br>"; //"<br> (<a href=\"javascript:rssimportToggleExcerpt('$itemid');\">" . elgg_echo('rssimport:less') . "</a>)<br><br>";
	$use_excerpt = true;
}
...
echo "<div class=\"rssimport_content\" id=\"rssimport_content" . $itemid . "\">";
echo $content;
echo "</div>";
