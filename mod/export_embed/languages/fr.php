...
$fr = array(
	...
	'export_embed:help' => "Ces widgets permettent d'accéder à diverses informations de ce site à partir d'un autre site, et en particulier à partir d'un agrégateur ou d'un tableau de bord personnel.<br />Ils sont accessibles par une URL générique ou personnalisée, et peuvent être intégré sur votre bureau, ou dans un site web.",
