 ...
 * @param bool $use_owner Use owner_guid instead of container_guid - Facyla patch
 * @return array
 */
function blog_get_page_content_list($container_guid = NULL, $use_owner = false) {
...
function blog_prepare_form_vars($post = NULL, $revision = NULL) {
	...
	if ($auto_save_annotations = $post->getAnnotations(array('annotation_names' => 'blog_auto_save', 'limit' => 1))) {
