...
if ($add_options || $remove_options) {
	echo '<div class="event_add_or_remove_form">';
	  ...
	  if ($add_options) {
		  ...
		  $submit_button = elgg_view("input/submit",array("value"=>elgg_echo('event_calendar:add_to_group:add_group_button')));
	  ...
	  if ($remove_options) {
		  ...
		  $submit_button = elgg_view("input/submit",array("value"=>elgg_echo('event_calendar:add_to_group:remove_group_button')));
