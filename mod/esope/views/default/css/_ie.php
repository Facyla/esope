...
/* Suite à la mise en place du thème ADF */
ul#groups-tools > li { max-width:47%; }
ul.elgg-menu-title li { float:right; }
#transverse form input#esope-search-submit-button { display: inline; margin: -27px 0 0 0; height:27px; }
