...
<div class="elgg-module elgg-module-info">
	...
	<div class="elgg-body">
		...
		?>
		<p>
		<label for="current_password"><?php echo elgg_echo('user:current_password:label'); ?>:</label>
		<?php
		...
		<p>
		<label for="password"><?php echo elgg_echo('user:password:label'); ?>:</label>
		<?php
		...
		<p>
		<label for="password2"><?php echo elgg_echo('user:password2:label'); ?>:</label> <?php
