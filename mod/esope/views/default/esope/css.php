...
a.esope-popup-toggle { padding: 0.2em 0.6em; background: <?php echo $titlecolor; ?>; color: white; display: inline-block; }
a.esope-popup-toggle:hover, .esope-popup-toggle:active, .esope-popup-toggle:active { color: white; }
a.esope-lightbox-toggle { padding: 0.2em 0.6em; background: <?php echo $titlecolor; ?>; color: white; display: inline-block; }
...
#esope-homepage .elgg-module-walledgarden { position: relative; }
