...
$metadata_search_fields = "tags:auto, category:auto";
...
$metadata_search .= '<div class="esope-search-metadata esope-search-metadata-select"><label>' . elgg_echo('esope:search:subtype') . ' ' . elgg_view('input/select', array('name' => 'entity_subtype', 'value' => '', 'options_values' => $subtypes_opt)) . '</label></div>';

$metadata_search .= '<div class="esope-search-metadata esope-search-metadata-select"><label>' . elgg_echo('search:field:container_guid') . ' ' . elgg_view('input/groups_select', array('name' => 'container_guid', 'value' => '')) . '</label></div>';
$metadata_search .= '<div class="esope-search-metadata esope-search-metadata-select"><label>' . elgg_echo('search:field:owner_guid') . ' ' . elgg_view('input/members_select', array('name' => 'owner_guid', 'value' => '')) . '</label></div>';
...
$search_form .= '<div class="esope-search-dates">';
	...
	$search_form .= '<div class="esope-search-date"><label><i class="fa fa-calendar"></i> ' . elgg_view('input/date', array('name' => 'created_time_lower', 'value' => $params['created_time_lower'], 'timestamp' => true)) . ' ' . elgg_echo('search:field:date:lower') . ' </label></div>';
	$search_form .= '<div class="esope-search-date"><label><i class="fa fa-calendar"></i>&nbsp;' . elgg_view('event_calendar/input/date_local', array('name' => 'created_time_upper', 'value' => $params['created_time_upper'], 'timestamp' => true)) . ' ' . elgg_echo('search:field:date:upper') . '</label></div>';
$search_form .= '</div>';
