...
if ($public_profiles == 'yes') {
	...
	if ($user) {
		...
		if ($public_profiles_default == 'no') {
			...
			$content .= elgg_view('input/select', array('name' => 'public_profile', 'options_values' => $no_yes_opt, 'value' => $user->public_profile));
		} else {
			$yes_no_opt = array( 'yes' => elgg_echo('option:yes'), 'no' => elgg_echo('option:no') );
			$content .= elgg_view('input/select', array('name' => 'public_profile', 'options_values' => $yes_no_opt, 'value' => $user->public_profile));
		}
		$content .= '</label></p>';
