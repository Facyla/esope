...
if ($num_of_likes) {
	...
	// Esope : patch hack to avoid repeating the next entities as liked
	// Note : this view's return seems to be used is no new non-empty value is returned
	// See https://github.com/Elgg/Elgg/issues/10004
	echo ' ';
}
