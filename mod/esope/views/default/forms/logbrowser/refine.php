...
// Form fields
$form = '';
	$form .= '<p><label>' . elgg_echo('logbrowser:user') . ' ' . elgg_view('input/text', array('name' => 'search_username', 'value' => $username, 'style' => 'max-width:25ex')) . '</label> &nbsp; ';
	$form .= '<label>' . elgg_echo('logbrowser:user_guid') . ' ' . elgg_view('input/text', array('name' => 'user_guid', 'value' => $user_guid, 'style' => 'max-width:10ex')) . '</label></p>';
