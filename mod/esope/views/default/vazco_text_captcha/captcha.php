...
// Esope : view has been move to its own folder so it does not replace core view and enables multiple captchas systems
if (elgg_is_active_plugin('vazco_text_captcha')) {
	...
	if (!empty($challenge_question) && !empty($challenge_question)) {
		//<label for="captcha-input-text"><?php echo elgg_echo('vazco_text_captcha:entercaptcha'); ?></label><br />
		?>
		<div class="captcha">
