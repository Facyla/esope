...
return array(
	...
	*/
	...
	'esope:membersearch:setting:metadata' => "Liste de metadata à utiliser pour la recherche multi-critère de membres (meta1, meta2, etc.)",
	...
	'esope:membersearch:setting:metadata_filter' => "Liste de filtres cachés ajoutés à la recherche",
	'esope:membersearch:setting:metadata_filter:details' => "Saisissez une liste de metadata et de valeurs à ajouter à la recherche des membres. Ces filtres ne seront pas montrés aux utilisateurs, mais seront utilisés pour filtrer les résultats de la recherche. Ex. : memberstatus=closed, is_active=yes",
	...
	'esope:thewire:group:add' => "Envoyer un message",
	...
	'thewire:notify:group:reply' => "%s a répondu à %s sur le Fil du groupe %s :",
	'thewire:notify:group:post' => "%s publié sur le Fil du groupe %s :",
	...
	'esope:pages:parent' => "Page parente&nbsp;: ",
	'esope:pages:parents' => "Pages parentes&nbsp;: ",
