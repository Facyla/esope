...
return array(
	...
	*/
	...
	'esope:settings:topbar:details' => "The topbar menu is usually used to provide links for the logged in user. You can select a custom menu to replace theme default menu.",
	'esope:settings:navigation' => "Main navigation menu",
	'esope:settings:navigation:details' => "This menu is used for the general navigation on the site. You can select a custom menu to replace theme default menu.",
