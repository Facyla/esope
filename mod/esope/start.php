...
// @TODO split into 1 hook per menu type ?
elgg_register_event_handler("pagesetup", "system", "esope_pagesetup"); // Menu
//elgg_register_plugin_hook_handler('register', 'menu:page', 'esope_menu_page');
//elgg_register_plugin_hook_handler('register', 'menu:owner_block', 'esope_menu_owner_block');
//elgg_register_plugin_hook_handler('register', 'menu:title', 'esope_menu_title');
