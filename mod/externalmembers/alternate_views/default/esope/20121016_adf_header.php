          ...
          <?php if (elgg_is_logged_in()) { ?>
            ...
            <nav>
              <ul>
                ...
                <?php } ?>
                <li><a href="<?php echo $url . 'pages/view/182/premiers-pas'; ?>"><?php echo elgg_echo('esope:help'); ?></a></li>
        ...
        <div id="transverse">
          <div class="interne">
            <nav>
              <ul>
                ...
                */
                ...
                <?php /* Pas d'annuaire
                <li class="members"><a <?php if(elgg_in_context('members') || elgg_in_context('profile')) { echo 'class="active elgg-state-selected"'; } ?> href="<?php echo $url . 'members'; ?>"><?php echo elgg_echo('esope:directory'); ?></a></li>
                */ ?>
            ...
            <form action="<?php echo $url . 'search'; ?>" method="post">
              ...
              <label for="esope-search-input" class="invisible"><?php echo $search_text; ?></label>
              <input type="text" id="esope-search-input" name="q" value="<?php echo $search_text; ?>" />
              <input type="image" id="esope-search-submit-button" src="<?php echo $urlicon; ?>recherche.png" value="<?php echo elgg_echo('esope:search'); ?>" />
            </form>
            */ ?>
          </div>
        </div>
