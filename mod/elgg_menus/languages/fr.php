...
$fr = array(
	...
	'elgg_menus:item:href' => "URL",
	'elgg_menus:item:name' => "Nom (interne)",
	'elgg_menus:item:title' => "Titre (infobulle)",
	'elgg_menus:item:confirm' => "Message de confirmation",
	...
	'elgg_menus:item:priority' => "Priorité (1 à 1000)",
	'elgg_menus:item:contexts' => "Contexte(s) ('all' par défaut)",
	'elgg_menus:item:selected' => "Sélectionné ?",
	'elgg_menus:item:parent_name' => "Identifiant de l'item parent",
