...
$fr = array(
	...
	'elgg_menus:mode:details' => "Les menus personnalisés peuvent fonctionner de 2 manières :<br />
		 - \"Fusion\" = les items configurés ci-dessous sont ajoutés au menu existant. Ceci est le mode recommandé, car il permet à d'autres plugins d'ajouter ou d'enlever des éléments du menu, mais vous permet également de retirer certains de ces items du menu si vous le souhiatez (avec les \"Items à supprimer\")<br />
		  - \"Remplacement\" = les items du menu remplacent et annulent le menu prédéfini. A n'utiliser que pour des menus statiques, ou lorsque vous souhaitez contrôler totalement les items du menu. Attention, plus aucun plugin ne pourra enregistrer d'item dans ce menu.<br />
		  ATTENTION : le remplacement du menu risque de ne pas fonctionner correctement avec les menus prédéfinis (ceux du système ou générés par d'autres plugins), car ceux-ci ne sont pas tous définis lors de l'initialisation des plugins.",
	...
	'elgg_menus:menu_remove:details' => "Si le menu est en mode \"fusion\", vous pouvez définir ici une liste d'items qui seront retirés du menu prédéfinit. Il s'agit généralement d'items dynamiques (définis par une vue) que vous ne souhaitez pas voir appraître. Cela peut être particulièrement utile si vous ne souhaitez pas remplacer intégralement un menu, mais seulement retirer certains de ses items.",
	...
	'elgg_menus:edit:items:details' => "Selon le mode choisi, ces items seront soit ajoutés au menu prédéfinit (fusion), soit remplacent ce menu.",
	'elgg_menus:edit:system_menu:details' => "Aucun menu personnalisé n'est encore défini pour ce menu. Les éléments du menu prédéfinit ont été pré-chargés.<br />Si vous souhaitez créer un menu personnalisé, éditez les éléments ci-dessous et enregistrez votre menu.",
	'elgg_menus:edit:custom_menu:details' => "Les items du menu personnalisé ci-dessous s'ajoutent à ceux du menu prédéfinit, ou les remplacent, selon le mode choisi.",
