<?php
	...
	function advanced_notifications_init(){
		...
		elgg_register_plugin_hook_handler("notify:entity:message", "object", "advanced_notifications_email_body_hook", 999);
		elgg_register_plugin_hook_handler("notify:annotation:message", "group_topic_post", "advanced_notifications_email_body_hook", 999);
