...
<p>
  	<label for="num_display_<?php echo $widget_id; ?>"><?php echo elgg_echo('event_calendar:num_display'); ?>:</label>
		<select id="num_display_<?php echo $widget_id; ?>" name="params[num_display]">
