...
$content = '';
$p_url = $CONFIG->url . 'project_manager/production/project/';
$edit_url = $CONFIG->url . 'project_manager/edit/';
...
if ((($container instanceof ElggGroup) || ($container instanceof ElggUser)) && ($project instanceof ElggObject)) {
  ...
  */
  ...
  $content .= '<form method="POST" id="' . $form_id . '" action="' . $CONFIG->url . 'action/project_manager/edit_project_production">';
