...
// tasks used to use Public for write access => change to LOGGEDIN
...
if ($revision) {
	...
	if ($annotation) { $annotation = $annotation[0]; }
}
...
$editor_link = elgg_view('output/url', array(
    'href' => "tasks/owner/$editor->username", 'text' => $editor->name, 'is_trusted' => true,
  ));
...
if ($comments_count != 0 && !$revision) {
	...
	$comments_link = elgg_view('output/url', array(
		  ...
		  'text' => $text, 'is_trusted' => true,
	  ));
}

$metadata = elgg_view_menu('entity', array(
	  'entity' => $vars['entity'], 'handler' => 'tasks',
...
if ($full) {
	...
	$params = array('entity' => $task, 'metadata' => $metadata, 'subtitle' => $subtitle, 'tags' => $tags);
	$params = $params + $vars;
	$summary = elgg_view('object/elements/summary', $params);
	echo elgg_view('object/elements/full', array(
		  'entity' => $task, 'icon' => $task_icon,
  ...
  $params = array(
	    'entity' => $task, 'metadata' => $metadata, 'tags' => $tags,
