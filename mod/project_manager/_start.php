...
function project_manager_url($entity) {
	...
	//return $CONFIG->url . "project_manager/" . $entity->getOwnerEntity()->username . "/read/" . $entity->getGUID() . "/" . $title;
	return $CONFIG->url . "project_manager/view/" . $entity->getGUID() . "/" . $title;
}
...
function project_manager_save_site_project_manager($hook, $type, $value, $params) {
	...
	if (!($plugin instanceof ElggPlugin)) {
		register_error(elgg_echo('plugins:settings:save:fail', array($plugin_id))); forward(REFERER);
	}
