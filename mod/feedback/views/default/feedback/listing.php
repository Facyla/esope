...
switch ($status) {
	...
	default:
		...
		if (elgg_is_admin_logged_in) {
			...
			$controls .= elgg_view("output/confirmlink",array('href' => $vars['url'] . "action/feedback/close?guid=" . $vars['entity']->guid, 'confirm' => elgg_echo('feedback:closeconfirm'), 'text' => '<i class="fa fa-check"></i>'));
		}
}
