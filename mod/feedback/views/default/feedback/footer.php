		...
		<div id="feedBackContent" class="elgg-module elgg-module-info">
			...
			<div id="feedBackFormInputs">
				<form id="feedBackForm" action="" method="POST">
					...
					<div id="feedBackText">
						<textarea name="feedback_txt" cols="34" rows="10" id="feedback_txt" placeholder="<?php echo elgg_echo('feedback:default:txt'); ?>" class="feedbackTextbox mceNoEditor" required></textarea>
					</div>
