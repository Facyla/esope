...
return array(
	...
	'postbymail:settings:replybuttonaddtext' => "Add a reply alternative text",
	'postbymail:settings:replybuttonaddtext:details' => "This option allows to enable a text message under the button, so that people using a mail service that does not handle HTML still can reply to the notification by copy/pasting the reply address.",
	'postbymail:settings:server' => "Server and port", 
	'postbymail:settings:server:details' => "in the form: localhost:143 or mail.domain.tld:995", 
	'postbymail:settings:protocol' => "Protocol to be used", 
	'postbymail:settings:protocol:details' => "if necessary (eg.: /notls or /imap/ssl, and also sometimes /novalidate-cert and /norsh)", 
	'postbymail:settings:mailbox' => "Mailbox to be used (usually INBOX, which is the generic name of IMAP inbox folder)", 
	'postbymail:settings:username' => "Mailbox username", 
	'postbymail:settings:username:details' => "eg.: user@domain.tld", 
	'postbymail:settings:email' => "Email address", 
	'postbymail:settings:email:details' => "optional, only if different from mailbox username", 
	'postbymail:settings:password' => "Mailbox password", 
	'postbymail:settings:inboxfolder' => "Folder to be checked", 
	'postbymail:settings:inboxfolder:details' => "default: INBOX", 
	...
	'postbymail:settings:email:title:details' => "Important: you have to create 2 folders into your mailbox account before using this plugin, named 'Published' and 'Errors'<br >Use the used mailbox account parameters to configure the plugin and enable it to retrieve messages.", 
	...
	'postbymail:usecontainer:comment' => "Reply to a comment: using container object",
	'postbymail:usecontainer:discussion_reply' => "Reply to a forum reply: using container object",
