...
Please visit %s in order to approve/delete the users.",
	...
	'uservalidationbyadmin:noipinfo' => "no information available on registration IP",
	'uservalidationbyadmin:geoinfo' => "IP %s, guessed geolocation&nbsp;: %s",
	'uservalidationbyadmin:userinfo' => "Pending approval for %s : username %s, email %s",
	'uservalidationbyadmin:userinfo:geo' => "Pending approval for %s : username %s, email %s, %s",
