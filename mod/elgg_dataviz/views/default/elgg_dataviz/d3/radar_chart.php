...
$data = elgg_extract('data', $vars); // JS data (for direct use)
$description = elgg_extract('description', $vars); // Titre du radar
$objects = elgg_extract('objects', $vars); // Eléments de légende (entités à comparer) - JSON
