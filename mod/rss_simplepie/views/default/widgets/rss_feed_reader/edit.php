...
$url_label = elgg_echo("rss_simplepie:feed_url");
...
$num_items_label = elgg_echo('rss_simplepie:num_items');
...
$excerpt_label = elgg_echo('rss_simplepie:excerpt');
...
$post_date_label = elgg_echo('rss_simplepie:post_date');
