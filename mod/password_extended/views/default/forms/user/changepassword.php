...
echo elgg_autop(elgg_echo('user:changepassword:change_password_confirm'));


?>

<div class="elgg-field">
    <label for="register-password2"><?php echo elgg_echo('user:password:label'); ?>*</label>
    <div class="profile_manager_register_input_container">
        <input value="" autocapitalize="off" autocomplete="off" autocorrect="off" id="password1" name="password1"
...
<div id="retype_password" class="elgg-field">
    <label for="register-password2"><?php echo elgg_echo('user:password2:label'); ?>*</label>
    <div class="profile_manager_register_input_container">
