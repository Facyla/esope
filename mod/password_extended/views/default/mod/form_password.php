...
<div class="elgg-module elgg-module-info">
    <div class="elgg-head"><h3><?php echo elgg_echo('password_extended:password_header'); ?></h3></div>
    <div class="elgg-body">
        <div class="elgg-field">
            <label for="elgg-field-ue2gm5"
                   class="elgg-field-label"><?php echo elgg_echo('password_extended:current_password'); ?></label>
            <input value="" autocapitalize="off" autocorrect="off" type="password" name="current_password"
                   id="current_password" class="elgg-input-password">
        </div>
        <div class="elgg-field">
            <label for="elgg-field-vts7sq"
                   class="elgg-field-label"><?php echo elgg_echo('password_extended:new_password'); ?></label>
            <input value="" autocapitalize="off" autocorrect="off" type="password" name="password" id="password"
                   maxlength="<?= ($setting['maxLength']=='yes') ? $password_max_lenght_value : '' ?>" class="elgg-input-password">
            <div id="pass-info">
            </div>
            <br>
            <div id="retype_password" class="elgg-field">
                <label for="elgg-field-8vleod"
                       class="elgg-field-label"><?php echo elgg_echo('password_extended:retype_password'); ?></label>
                <input value="" autocapitalize="off" autocorrect="off" type="password" name="password2" id="password2"
                       maxlength="<?= ($setting['maxLength']=='yes') ? $password_max_lenght_value : '' ?>" class="elgg-input-password">
            </div>
        </div>
    </div>
