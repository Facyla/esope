...
return array(
	...
	'disable_content:index:details' => "Cette page vous permet de consulter la liste des publications désactivées, d'avoir un aperçu de leur contenu, et de les réactiver.",
	
	// Form
	'disable_content:information' => "Les publications désactivées sont <strong>invisibles des membres et des administrateurs</strong>&nbsp;; elles n'apparaissent pas dans le moteur de recherche, et sont de fait considérées comme n'existant plus.<br /><br />Une fois réactivées, les publications retrouvent leur adresse d'origine, ainsi que l'ensemble des informations associés&nbsp;: membres, contenus, niveaux d'accès, etc.",
	...
	'disable_content:disable' => "<i class=\"fa fa-eye-slash\"></i>&nbsp;Désactiver",
	'disable_content:enable' => "<i class=\"fa fa-eye\"></i>&nbsp;Activer",
