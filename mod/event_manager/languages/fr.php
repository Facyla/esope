...
return array (
  ...
  'event_manager:list:navigation:upcoming' => 'A venir',
  'collection:object:event' => 'Événements',
  'event_manager:list:upcoming' => 'Événements à venir',
  'event_manager:event:attendees:title' => '%s : %s',
  'river:object:event:comment' => '%s a commenté l\'événement %s',
  'river:object:event:create' => '%s a créé l\'événement %s',
  'event_manager:settings:add_event_to_calendar:help' => 'Cela comprendra également les liens figurant dans les notifications par mail',
  'event_manager:settings:add_event_to_calendar' => 'Afficher le bouton "Ajouter au calendrier" sur la page de l\'événement',
  'event_manager:settings:rsvp:interested' => 'Ajouter l\'option "Intéressé"',
  'event_manager:settings:osm:osm_detail_zoom' => 'Entrez un niveau de zoom pour les détails de l\'événement (0 = zoom arrière, 19 = zoom avant)',
  'event_manager:settings:osm:osm_default_zoom' => 'Entrez un niveau de zoom par défaut de la carte (0 = zoom arrière, 19 = zoom avant)',
  'event_manager:settings:osm:osm_default_location_lng' => 'Entrez la longitude  par défaut pour les cartes de localisation',
  'event_manager:settings:osm:osm_default_location_lat' => 'Entrez la latitude par défaut pour les cartes de localisation',
  'event_manager:settings:osm:osm_default_location' => 'Saisir un emplacement par défaut sur lequel les cartes doivent être centrées',
  ...
  'event_manager:settings:google_maps:google_maps_detail_zoom' => 'Entrez un niveau de zoom pour les détails de l\'événement (0 = zoom arrière, 19 = zoom avant)',
  'event_manager:settings:maps:provider:none' => 'Aucune',
  'event_manager:settings:maps:provider' => 'Source de cartes',
  'event_manager:settings:maps:provider:help' => 'Ce paramètre détermine la source des cartes qui sera utilisée pour afficher les événements sur la carte ou pour sélectionner / rechercher une adresse pour un événement donné.',
  'event_manager:settings:maps' => 'Paramètres d\'intégration des cartes',
  'event_manager:action:attendees:export:no_data' => 'Pas d\'élément à exporter',
  'event_manager:event:view:attendees:more' => '+ %s plus',
  'event_manager:event:registration:notification:user:text:event_spotfree' => 'Bonjour %s,

Votre participation à l\'événement \'%s\' (%s) a été approuvée. Vous avez été déplacé de la liste d\'attente à la liste des participants.',
  'event_manager:event:relationship:event_interested:undo' => 'N\'est plus intéressé',
  'event_manager:event:relationship:event_presenting:undo' => 'Annuler la présentation',
  'event_manager:event:relationship:event_exhibiting:undo' => 'Annuler l\'exposition',
  'event_manager:event:relationship:event_organizing:undo' => 'Annuler l\'organisation',
  'event_manager:event:relationship:event_attending:undo' => 'Annuler la participation',
  ...
  'event_manager:edit:form:tabs:profile' => 'Présentation',
  ...
  'event_manager:edit:form:tabs:toggle' => 'Afficher les options',
  ...
  'event_manager:registration:slot_set:info' => 'Ce programme contient des ensembles de créneaux. Vous ne pouvez qu\'un de chaque ensemble.',
...
Vous êtes maintenant désinscrit(e) de l\'évènement \'%s\' .',
  ...
  'event_manager:action:registration:edit:error_slots' => 'Vous ne pouvez choisir qu\'un seul créneau par ensemble. Plus d\'un ont été choisit pour l\'ensemble %s.',
