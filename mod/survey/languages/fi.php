...
return [
	...
	'survey:group_survey' => "Ryhmän kyselyt",
	'survey:group_survey:listing:title' => "Käyttäjän %s kyselyt",
	...
	'item:object:survey' => 'Kyselyt',
	'item:object:survey_choice' => "Vaihtoehdot",
	...
	'survey:show_survey' => "Näytä kysely",
	...
	'survey:survey_closing_date' => "(Kyselyn sulkeutumisajankohta: %s)",
	...
	'survey:settings:group_survey_default' => "Kyllä",
	'survey:settings:group_survey_not_default' => "Ei",
	...
	'survey:settings:allow_open_survey:title' => "Ota käyttöön avoimet kyselyt? (Näyttää vastausten kohdalla niihin vastanneet henkilöt)",
	...
	'group:survey:empty' => "Ei kyselyitä",
	...
	'survey:open_survey_label' => "Näytä tuloksien yhteydessä, kuka on vastannut mihinkin kysymykseen",
	...
	'survey_individual:widget:description' => "Näyttää päivän kyselyn",
	'survey:widget:no_survey' => "%s ei ole vielä luonut kyselyitä.",
	'survey:widget:nonefound' => "Ei kyselyitä.",
	'survey:widget:think' => "Vastaa käyttäjän %s kyselyihin!",
	'survey:enable_survey' => "Ota käytöön ryhmän kyselyt",
...
',
	...
	'river:create:object:survey' => '%s loi kyselyn %s',
	'river:vote:object:survey' => '%s vastasi kyselyyn %s',
	'river:comment:object:survey' => '%s kommentoi kyselyä %s',
