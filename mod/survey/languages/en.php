...
',
	...
	'river:object:survey:create' => '%s created a survey %s',
	'river:object:survey:response' => '%s responded on the survey %s',
	'river:object:survey:comment' => '%s commented on the survey %s',
