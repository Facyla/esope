...
$debug = elgg_get_plugin_setting('debug_mode', 'content_facets');
...
// @TODO : plugin setting per resource type (multiselect) : inline replacement (yes/no), display after content (yes/no)
...
// Extract details from text : @, #, URLs + type of resource
$facets = new ElggContentFacets($text);


// In-text replacements: @ # URLs

// Content extend: videos, preview
