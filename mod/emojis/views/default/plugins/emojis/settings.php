...
// TheWire action
echo '<div><label>' . elgg_echo('emojis:settings:debug') . elgg_view('input/select', array('name' => 'params[debug]', 'options_values' => $no_yes_opt, 'value' => $vars['entity']->debug)) . '</label></div>';
