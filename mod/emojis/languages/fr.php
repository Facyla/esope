...
return array(
	...
	'emojis:settings:output_hook:details' => "Convertit les sorties pour permettre d'afficher les emojis sous forme d'entités HTML. Utile si des emojis sont conservés sous forme de shortcodes (:emoji:), ou ont été doublement encodés en HTML (htmlentities(\$emojis_html_codepoint)).<br />Inutile si vous n'utilisez pas de shortcodes emojis, et si les emojis ont été correctement encodés&nbsp;: la base de données devrait contenir des chaînes similaires à &amp;xAAAAAA; et non &amp;amp;xAAAAAA;.",
