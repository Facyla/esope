...
// Le Fil
$thewire = '<span style="float:right;"><a href="' . $CONFIG->url . 'thewire/all">' . elgg_echo('link:view:all') . '</a></span><h2><img src="' . $urlpictos . 'thewire_45.png" />' . elgg_echo('theme_cocon:thewire:title') . '</h2>' . elgg_view_form('thewire/add', array('class' => 'thewire-form')) . elgg_view('input/urlshortener');
...
// Activité du site
$site_activity = '<span style="float:right;"><a href="' . $CONFIG->url . 'activity">' . elgg_echo('link:view:all') . '</a></span><h2><img src="' . $urlpictos . 'activity.png" />' . elgg_echo('theme_cocon:site:activity') . '</h2>';
