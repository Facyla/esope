...
$thewire = '<span class="viewall" style="float:right;"><a href="' . $CONFIG->url . 'thewire/all">' . elgg_echo('link:view:all') . '</a></span><h2><i class="fa fa-comments"></i> ' . elgg_echo('theme_cocon:thewire:title') . '</h2>' . elgg_view_form('thewire/add', array('class' => 'thewire-form')) . elgg_view('input/urlshortener');
...
$site_activity = '<span class="viewall" style="float:right;"><a href="' . $CONFIG->url . 'activity">' . elgg_echo('link:view:all') . '</a></span><h2><i class="fa fa-flash"></i> ' . elgg_echo('theme_cocon:site:activity') . '</h2>';
