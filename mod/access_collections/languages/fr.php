...
return array(
	...
	'access_collections:upcomingfeature' => "Fonctionnalité à venir",
	
	// Settings
	'access_collections:collections:profiletypes' => "ACL des types de profils personnalisés",
	'access_collections:profiletypes' => "Types de profils personnalisés",
	'access_collections:profiletypes:select' => "Sélectionnez les types de profils qui devraient disposer de leurs propres niveaux d'accès.",
	'access_collections:acl' => "ACL = %s, access_id = %s",
	'access_collections:noacl' => "pas d'ACL",
	'access_collections:collections:admin' => "Collections définies par les administrateurs",
	'access_collections:collection:new' => "Créer un nouveau niveau d'accès",
	'access_collections:collection:newid' => "Id du nouveau niveau d'accès&nbsp;: %s",
	'access_collections:collection:newmembers' => "Membres associés au niveau d'accès&nbsp;:",
	
	// Messages & errors
	'access_collections:acl:created' => "Nouveau niveau d'accès créé.",
