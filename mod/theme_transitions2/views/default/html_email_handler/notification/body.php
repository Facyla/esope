	...
	<body>
		...
		<div id="notification_container">
			<div id="notification_header">
				<?php
				$header_text = '<img src="' . $site_url . 'mod/theme_transitions2/graphics/logo-transitions2-small.png" alt="' . $site->name . '" />';
				echo elgg_view("output/url", array("href" => $site_url, "text" => $header_text, "is_trusted" => true));
				?>
			</div>
			...
			<div id="notification_footer">
				<div id="notification_footer_logo">
					<?php echo '<img src="' . $site_url . 'mod/theme_transitions2/graphics/logo-transitions2-small-square.png" alt="' . $site->name . '" />'; ?>
				</div>
