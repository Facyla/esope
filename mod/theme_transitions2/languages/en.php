...
",
	...
	'theme_transitions:loginwithfing' => "You can login with you Réseau Fing account by using your usual credentials on this site.",
	'theme_transitions:registerwithfing' => "You do not need to create an account: please <a href=\"{$url}login\">use your Réseau Fing credentials on the login page</a>.",
	'theme_transitions:login:loggedinwithfing' => "Login successful with your Réseau Fing account.",
	'theme_transitions:register:subtitle' => "to create a contributor account",
	'theme_transitions:registerwithfing:title' => "Option: You already have an account on Réseau Fing",
	'theme_transitions:registerwithhybridauth:title' => "Option: Fill your registration form with",
	'theme_transitions:registerwithemail:title' => "Option: Register with your email account",
