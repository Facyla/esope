...
return array(
	...
	// Messages and errors
	'theme_transitions2:register:usernametooshort' => "Identifiant de connexion trop court, un identifiant vous a été créé automatiquement.",
	'theme_transitions2:register:subject' => "Vous vous êtes bien enregistré sur Transitions²",
...
",
	...
	'theme_transitions:registerwithfing' => "Vous n'avez pas besoin de vous inscrire, veuillez <a href=\"{$url}login\">vous connecter directement en utilisant vos identifiants Réseau Fing</a>.",
	'theme_transitions:register:subtitle' => "pour créer un compte de contributeur",
	'theme_transitions:registerwithfing:title' => "Option : Vous avez déjà un compte sur le Réseau Fing",
	'theme_transitions:registerwithhybridauth:title' => "Option : Pré-remplissez votre inscription avec",
	'theme_transitions:registerwithemail:title' => "Option : Inscrivez-vous avec votre email",
