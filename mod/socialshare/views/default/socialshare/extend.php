		...
		if (elgg_get_plugin_setting($key.'_enable', 'socialshare') == 'yes') {
			switch($key) {
				case 'twitter':
					...
					*/
					echo '<a target="_blank" href="https://twitter.com/intent/tweet?url=' . $share_url . '&text=' . $title . '"><img src="' . $imgurl . 'twitter/bird_blue_16.png" alt="Twitter" title="' . elgg_echo("socialshare:$key:title") . '" /></a>';
					// '&via=&hashtags=
					break;
				...
				case 'google':
					...
					echo '<a target="_blank" href="https://plus.google.com/share?url=' . $share_url . '"><img src="' . $imgurl . 'googleplus.png" alt="Google+" title="' . elgg_echo("socialshare:$key:title") . '" /></a>';
					break;
