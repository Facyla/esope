...
// Integrate theme CSS (default wrapper), or use custom CSS => see CSS view
	...
	<body>
		...
		<div id="notification_container">
			...
			<div id="notification_header">
				<img style="float:left; margin-right:1em; max-height:60px;" src="<?php echo elgg_get_site_url(); ?>mod/theme_afpa_dsp/graphics/AFPA_transparent.gif" alt="Logo AFPA">
				<?php
