...
if (elgg_is_active_plugin('thewire') && ($index_wire == 'yes')) {
	...
	$thewire .= '<div id="thewire_homeform" style="display:block;">' . elgg_view_form('thewire/add', array('class' => 'thewire-form no-spaces'), array('access_id' => 1)) . elgg_view('input/urlshortener') . '</div>';
	elgg_push_context('widgets');
...
$body .= '<div class="home-static-container home-kdb">' . $kdb . '</div>';
