...
define(function(require) {
	...
	var saveDraftCallback = function(data, textStatus, XHR) {
		if (textStatus == 'success' && data.success == true) {
			var form = $('form[id=transitions-post-edit]');
			...
			$(".transitions-save-status-time").html(d.toLocaleDateString() + " @ " + d.getHours() + ":" + mins);
		} else {
			$(".transitions-save-status-time").html(elgg.echo('error'));
		}
	};
	...
	var saveDraft = function() {
		...
		var draftURL = elgg.config.wwwroot + "action/transitions/auto_save_revision";
	...
	var init = function() {
		...
		oldDescription = $('form[id=transitions-post-edit]').find('textarea[name=description]').val();
