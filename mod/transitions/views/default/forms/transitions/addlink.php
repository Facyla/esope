...
echo '<label>' . elgg_echo('transitions:form:addlink') . '<br />' . elgg_view('input/url', array('name' => 'url', 'style' => "max-width:20em;")) . '</label>';
...
echo elgg_view('input/submit', array('value' => elgg_echo('transitions:addlink')));
