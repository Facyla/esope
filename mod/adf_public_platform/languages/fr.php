...
$fr = array(
  ...
  'widgets:profile_completeness:view:tips:link' => "<br />%s&raquo;&nbsp;Compléter mon profil !%s",
	...
	'adf_platform:settings:contact:contactemail:help' => "",
	'adf_platform:settings:contact:rss' => "URL du flux RSS",
	'adf_platform:settings:contact:rss:help' => "",
	'adf_platform:settings:contact:twitter' => "URL de la page Twitter (compte ou recherche sur hashtag)",
	'adf_platform:settings:contact:twitter:help' => "",
	'adf_platform:settings:contact:facebook' => "URL de la page/compte Facebook",
	'adf_platform:settings:contact:facebook:help' => "",
	'adf_platform:settings:contact:googleplus' => "URL de la page/compte Google+",
	'adf_platform:settings:contact:googleplus:help' => "",
	'adf_platform:settings:contact:linkedin' => "URL de la page/compte Linkedin",
	'adf_platform:settings:contact:linkedin:help' => "",
	'adf_platform:settings:contact:netvibes' => "URL de la page/compte Netvibes",
	'adf_platform:settings:contact:netvibes:help' => "",
	'adf_platform:settings:contact:flickr' => "URL de la page/compte FlickR",
	'adf_platform:settings:contact:flickr:help' => "",
	'adf_platform:settings:contact:youtube' => "URL de la page/compte Youtube",
	'adf_platform:settings:contact:youtube:help' => "",
	'adf_platform:settings:contact:dailymotion' => "URL de la page/compte Dailymotion",
	'adf_platform:settings:contact:dailymotion:help' => "",
	'adf_platform:settings:contact:pinterest' => "URL de la page/compte Pinterest",
