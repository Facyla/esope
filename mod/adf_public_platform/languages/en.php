...
$en = array(
	...
	'adf_platform:config:behaviour' => "BEHAVIOUR & SETTINGS",
...
'adf_platform:groupinvite' => "pending group invite request",
	...
	'adf_platform:settings:replace_public_homepage' => "Replace homepage ? (note : only if walled garden is disabled !)",
	'adf_platform:replacehome:no' => "No",
	'adf_platform:replacehome:default' => "Yes : use default (configurable) theme homepage",
	'adf_platform:replacehome:cmspages' => "Yes : use a custom CMS page (homepage-public)",
