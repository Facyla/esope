...
<div class="elgg-user-picker">
	...
	<label>
		...
		//echo elgg_echo('userpicker:only_friends');
		if ($vars['friends_only'] == 'yes_force') {
			echo '<input type="checkbox" name="match_on" value="true" checked="checked" class="hidden" />';
		} else if ($vars['friends_only'] == 'no_force') {
			// Default behaviour if nothing set
		} else if ($vars['friends_only'] == 'no') {
			echo '<input type="checkbox" name="match_on" value="false" />';
			echo elgg_echo('userpicker:only_friends');
		} else {
			echo '<input type="checkbox" name="match_on" value="true" checked="checked" />';
			echo elgg_echo('userpicker:only_friends');
		}
		?>
	</label>
