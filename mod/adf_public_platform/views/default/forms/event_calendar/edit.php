...
$body .= '<p><label for="title">'.elgg_echo("event_calendar:title_label").'<br />';
...
$body .= '<p><label for="venue">'.elgg_echo("event_calendar:venue_label").'<br />';
...
if ($event_calendar_times != 'no') {
	...
	if ($event_calendar_hide_end != 'yes') {
		$body .= '<p><label for="start_date">'.elgg_echo('event_calendar:from_label').'</label>';
	}
	...
	if ($event_calendar_hide_end != 'yes') {
		$body .= '</p><p><label for="end_date">'.elgg_echo('event_calendar:to_label').'</label>';
	...
	$body .= '<p><label for="start_date">'.elgg_echo("event_calendar:start_date_label").'<br />';
	...
	if ($event_calendar_hide_end != 'yes') {		
		$body .= '<p><label for="end_date">'.elgg_echo("event_calendar:end_date_label").'<br />';
...
if ($event_calendar_spots_display == 'yes') {
	$body .= '<p><label for="spots">'.elgg_echo("event_calendar:spots_label").'<br />';
...
$body .= '<p><label for="description">'.elgg_echo("event_calendar:brief_description_label").'<br />';
...
if ($event_calendar_type_display == 'yes') {
	...
	if ($type_list) {
		...
		$body .= '<p><label for="event_type">'.elgg_echo("event_calendar:type_label").'<br />';
...
if ($event_calendar_personal_manage == 'by_event') {
	$body .= '<p><label for="personal_manage">'.elgg_echo('event_calendar:personal_manage:label').'<br />';
...
if($event_calendar_hide_access == 'yes') {
	...
	$body .= '<p><label for="access_id">'.elgg_echo("access").'<br />';
