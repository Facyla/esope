...
// Generate random password (quicker user account creation)
...
if ($admin_option) {
	...
	if (elgg_is_active_plugin('profile_manager')) {
		echo "<div>" . elgg_view('input/checkboxes', array('name' => "notify", 'options' => array(elgg_echo('profile_manager:admin:adduser:notify') => 1), 'value' => 1)) . "</div>";
