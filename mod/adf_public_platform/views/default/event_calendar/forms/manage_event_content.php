...
$body .= '<p><label for="event_title">'.elgg_echo("event_calendar:title_label").'<br />';
$body .= elgg_view("input/text",array('id' => 'event_title', 'internalname' => 'title','value'=>$title));
$body .= '</label></p>';
$body .= '<p class="description">'.$prefix['title'].elgg_echo('event_calendar:title_description').'</p>';

$body .= '<p><label for="event_venue">'.elgg_echo("event_calendar:venue_label").'<br />';
$body .= elgg_view("input/text",array('id' => 'event_venue', 'internalname' => 'venue','value'=>$venue));
$body .= '</label></p>';
$body .= '<p class="description">'.$prefix['venue'].elgg_echo('event_calendar:venue_description').'</p>';

if ($event_calendar_times != 'no') {
	$body .= '<p><label for="event_start_time">'.elgg_echo("event_calendar:start_time_label").'</label><br />';
	$body .= elgg_view("input/timepicker",array('id' => 'event_start_time', 'internalname' => 'start_time','value'=>$start_time));
	$body .= '</p>';
	$body .= '<p class="description">'.$prefix['start_time'].elgg_echo('event_calendar:start_time_description').'</p>';
}

$body .= '<p><label for="event_start_date">'.elgg_echo("event_calendar:start_date_label").'<br />';
$body .= elgg_view("input/datepicker_popup",array('id' => 'event_start_date', 'internalname' => 'start_date','value'=>$start_date));
$body .= '</label></p>';
...
if ($event_calendar_hide_end != 'yes') {
	if ($event_calendar_times != 'no') {
		$body .= '<p><label for="event_end_time">'.elgg_echo("event_calendar:end_time_label").'</label><br />';
		$body .= elgg_view("input/timepicker",array('id' => 'event_end_time', 'internalname' => 'end_time','value'=>$end_time));
		$body .= '</p>';
		$body .= '<p class="description">'.$prefix['end_time'].elgg_echo('event_calendar:end_time_description').'</p>';
	}
	
	$body .= '<p><label for="event_end_date">'.elgg_echo("event_calendar:end_date_label").'<br />';
	$body .= elgg_view("input/datepicker_popup",array('id' => 'event_end_date', 'internalname' => 'end_date','value'=>$end_date));
	$body .= '</label></p>';
	$body .= '<p class="description">'.$prefix['end_date'].elgg_echo('event_calendar:end_date_description').'</p>';
}

if ($event_calendar_spots_display == 'yes') {
	$body .= '<p><label for="event_spots">'.elgg_echo("event_calendar:spots_label").'<br />';
	$body .= elgg_view("input/text",array('id' => 'event_spots', 'internalname' => 'spots','value'=>$spots));
	$body .= '</label></p>';
	$body .= '<p class="description">'.$prefix['spots'].elgg_echo('event_calendar:spots_description').'</p>';
}

if ($event_calendar_add_users == 'yes') {
	$body .= '<p><label for="do_adduser">'.elgg_echo("event_calendar:add_user_label").'<br />';
...
$body .= '<p><label for="event_brief_description">'.elgg_echo("event_calendar:brief_description_label").'<br />';
$body .= elgg_view("input/text",array('id' => ''event_brief_description'', 'internalname' => 'brief_description','value'=>$brief_description));
$body .= '</label></p>';
$body .= '<p class="description">'.$prefix['brief_description'].elgg_echo('event_calendar:brief_description_description').'</p>';

if ($event_calendar_region_display == 'yes') {
	$region_list = trim(elgg_elgg_get_plugin_setting('region_list', 'event_calendar'));
	$region_list_handles = elgg_elgg_get_plugin_setting('region_list_handles', 'event_calendar');
	...
	if ($region_list) {
		...
		$body .= '<p><label for="region">'.elgg_echo("event_calendar:region_label").'<br />';
...
if ($event_calendar_type_display == 'yes') {
	$type_list = trim(elgg_elgg_get_plugin_setting('type_list', 'event_calendar'));
	$type_list_handles = elgg_elgg_get_plugin_setting('type_list_handles', 'event_calendar');
	// make sure that we are using Unix line endings
	...
	if ($type_list) {
		...
		$body .= '<p><label for="event-type">'.elgg_echo("event_calendar:type_label").'<br />';
...
$body .= '<p><label for="fees">'.elgg_echo("event_calendar:fees_label").'<br />';
...
$body .= '<p><label for="contact">'.elgg_echo("event_calendar:contact_label").'<br />';
...
$body .= '<p><label for="organiser">'.elgg_echo("event_calendar:organiser_label").'<br />';
...
$body .= '<p><label for="event_tags">'.elgg_echo("event_calendar:event_tags_label").'<br />';
...
$body .= '<p><label for="long_description">'.elgg_echo("event_calendar:long_description_label").'<br />';
...
if($event_calendar_hide_access == 'yes') {
	...
	$body .= '<p><label for="event_access">'.elgg_echo("access").'<br />';
	$body .= elgg_view("input/access",array('id' => 'event_access', 'internalname' => 'access','value'=>$access));
	$body .= '</label></p>';
}
