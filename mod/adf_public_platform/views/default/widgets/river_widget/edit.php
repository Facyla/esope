...
if (elgg_in_context('dashboard')) {
	...
	?>
	<div>
  	<label for="content_type_<?php echo $widget_id; ?>"><?php echo elgg_echo('river:widget:type'); ?></label>
...
?>
<div>
	<label for="num_display_<?php echo $widget_id; ?>"><?php echo elgg_echo('river:numbertodisplay'); ?></label>
