...
// Facyla : this is not the most useful form - replying to shortened content is not really expected in a professionnal context
// We want to invite to read the whole text before commenting
/*
// inline comment form
