...
if (strlen($vars['q']) < 3) {
	...
	// Iris : exclude subgroups
	$options['wheres'][] = "NOT EXISTS ( SELECT 1 FROM " . elgg_get_config('dbprefix') . "entity_relationships WHERE guid_one = e.guid AND relationship = '" . AU_SUBGROUPS_RELATIONSHIP . "' )";
	$options['order_by'] = "g.name ASC";
