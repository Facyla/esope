...
HTML;
	...
	if (elgg_in_context('widgets')) {
		...
		$subtitle = '';
		$metadata = '';
		$owner_icon = $link = elgg_view('output/url', array('href' => $bookmark->address, 'text' => elgg_view_icon('push-pin-alt'), 'target' => '_blank', 'title' => elgg_echo('theme_inria:openinnewtab:bookmark', array($bookmark->address))));
