...
// @TODO : add setting so admins can set embedded image size ?
if (elgg_instanceof($entity, 'object', 'file') && (elgg_get_file_simple_type($entity->mimetype) == 'image')) {
	...
	$dl_url = elgg_get_site_url() . 'file/download/' . $entity->guid;
	$image .= '<span class="hidden"><a target="_blank" class="embed-insert" href="' . $dl_url . '"><img src="' . $dl_url . '" /></a></span>';
} else {
