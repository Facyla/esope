...
foreach($group_categories as $category => $name) {
	echo '<div class="iris-home-group-category">
		<a href="' . elgg_get_site_url() . 'groups/discover/' . $category . '">
			<img src="' . elgg_get_site_url() . 'theme_inria/graphics/groups_categories/' . $category . '.png" />
			<br />
			' . $name . '
		</a>
	</div>';
