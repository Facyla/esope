...
.elgg-context-login .elgg-module-aside { width: auto; }
...
.elgg-layout-group .elgg-list .elgg-item.elgg-item-object-thewire { border: 0; margin: 0 0 1.25rem 0; padding: 1.5rem 2rem; }
...
.iris-group-menu a.add { color: white; background: #1488CA; font-size:0.75rem; border-radius: 3rem; padding: 0.5rem 0.75rem 0.25rem 0.75rem; margin: 0.5rem 1rem 0rem 0; width: 10rem; text-align: center; hyphens: none; }
...
*/
#cboxLoadedContent { margin: 0 0 2rem 0; padding: 0rem; min-width: 32rem; width: auto; max-width: 100%; }
...
@media (max-width:980px) {
	...
	#iris-body .elgg-layout-one-sidebar .elgg-main { width: auto; padding:0; max-width: none; }
...
@media (max-width:768px) {
	* { min-width: initial !important; max-width: initial !important; }
	...
	#iris-body .iris-profile-title h2 { font-size: 2rem; }
	.iris-profile-icon { top: 2rem; left: 2rem; width: 6rem; height: 6rem; }
	...
	.iris-group-image { height: 6rem; width: 6rem; left: 2rem; top: 2rem; }
	.iris-group-title { top: 2rem; right: 2rem; left: 10rem; }
	#iris-body .iris-group-title h2 { font-size: 2rem; line-height: 2.25rem; }
	.iris-group-menu { padding-left: 2rem; }
