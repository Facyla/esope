...
.home-box h3:first-child { font-size:14px; font-family:NeoFont; margin-bottom: 0.8em; }
.home-wire, .home-activity { background:white; }
.home-wire h2 a, .home-activity h2 a { font-size:22px; margin-bottom: 0; }
...
/* Inria tools */
.inria-tool-widget .elgg-horizontal label { float: left; clear: none !important; min-width: 10ex; }
.elgg-button.inria-tool-link { padding: 3px 5px; margin: 4px; display: inline-block; }
...
/* Inria Tools Widget */
.inria-tool-link { padding-left: 34px; background-repeat: no-repeat !important; /* color: black; font-size: 18px; */ }
