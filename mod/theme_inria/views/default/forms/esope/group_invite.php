...
$content .= elgg_view('input/hidden', array('name' => 'group_invite_tab', 'value' => 'main'));
//$content .= "</div>";
$content .= "</fieldset></form>";

$action_url = elgg_get_site_url() . 'groups/invite/' . $group->guid . '/search';
if (current_page_url() == $action_url) {
	$content .= '<form id="esope-search-form-invite-groups" method="POST" class="elgg-form elgg-form-groups-invite-search" action="' . $action_url . '"><fieldset>';
} else {
	$content .= '<form id="esope-search-form-invite-groups" method="POST" class="elgg-form elgg-form-groups-invite-search hidden" action="' . $action_url . '"><fieldset>';
}
// Start search form based on members' metadata
$content .= elgg_view('input/hidden', array('name' => 'group_invite_tab', 'value' => 'search'));
