<?php
// Iris v2 : pas d'excerpt : fusionné en entête de la description
/**
 * Edit blog form
 *
 * @package Blog
...
$excerpt = '';
/* Iris v2 : fusion dans description
...
if (!empty($vars['excerpt'])) {
	$vars['description'] = '<p><strong>' . $vars['excerpt'] . '</strong></p>' . $vars['description'];
}
$excerpt = elgg_view('input/hidden', array('name' => 'excerpt', 'id' => 'blog_excerpt', 'value' => ''));
