...
echo "<div>";
echo "<label for='newsletter-title'>" . elgg_echo("theme_inria:newsletter:edit:title") . "</label>";
echo "<br /><em>" . elgg_echo("theme_inria:newsletter:edit:title:details") . "</em><br />";
echo elgg_view("input/text", array("name" => "title", "value" => $title, "id" => "newsletter-title"));
echo "</div>";

echo "<div>";
echo "<label for='newsletter-subject'>" . elgg_echo("theme_inria:newsletter:edit:subject") . "</label>";
echo "<br /><em>" . elgg_echo("theme_inria:newsletter:edit:subject:details") . "</em><br />";
echo elgg_view("input/text", array("name" => "subject", "value" => $subject, "id" => "newsletter-subject"));
echo "</div>";

echo "<div>";
echo "<label for='newsletter-description'>" . elgg_echo("theme_inria:newsletter:edit:description") . "</label>";
echo "<br /><em>" . elgg_echo("theme_inria:newsletter:edit:description:details") . "</em><br />";
echo elgg_view("input/plaintext", array("name" => "description", "value" => $description, "id" => "newsletter-description"));
echo "</div>";
