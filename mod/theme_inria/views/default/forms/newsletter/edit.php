...
$field = elgg_format_element('label', ['for' => 'newsletter-title'], elgg_echo('theme_inria:newsletter:edit:title'));
$field .= elgg_view('input/text', [
	'name' => 'title',
	'value' => $title,
	'id' => 'newsletter-title',
]);
$field .= elgg_format_element('div', ['class' => 'elgg-subtext'], elgg_echo('theme_inria:newsletter:edit:title:details'));
echo elgg_format_element('div', [], $field);

$field = elgg_format_element('label', ['for' => 'newsletter-subject'], elgg_echo('theme_inria:newsletter:edit:subject'));
$field .= elgg_view('input/text', [
	'name' => 'subject',
	'value' => $subject,
	'id' => 'newsletter-subject',
]);
$field .= elgg_format_element('div', ['class' => 'elgg-subtext'], elgg_echo('theme_inria:newsletter:edit:subject:details'));
echo elgg_format_element('div', [], $field);
...
$field = elgg_format_element('label', ['for' => 'newsletter-description'], elgg_echo('theme_inria:newsletter:edit:description'));
$field .= elgg_view('input/text', [
	'name' => 'description',
	'value' => $description,
	'id' => 'newsletter-description',
]);
$field .= elgg_format_element('div', ['class' => 'elgg-subtext'], elgg_echo("theme_inria:newsletter:edit:description:details") . '<br />' . elgg_echo('newsletter:edit:description:description'));
echo elgg_format_element('div', [], $field);
...
$field = elgg_format_element('label', ['for' => 'newsletter-access-id'], elgg_echo('theme_inria:newsletter:edit:access'));
...
$field .= elgg_format_element('div', ['class' => 'elgg-subtext'], elgg_echo('theme_inria:newsletter:edit:access:details'));
echo elgg_format_element('div', [], $field);
