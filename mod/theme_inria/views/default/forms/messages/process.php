...
echo '<p class="select-all"><label><input type="checkbox" id="checkAll" onClick="javascript: $(\'.elgg-item-object-messages:not(.hidden) input[type=checkbox]\').not(this).prop(\'checked\', this.checked);" />' . elgg_echo('theme_inria:selectall') . '</label></p>';
