...
$(document).ready(function() {
	...
	var start_hour = $('select[name="start_time_hour"]').val();
	var end_hour = $('select[name="end_time_hour"]').val();
	var start_minute = $('select[name="start_time_minute"]').val();
	var end_minute = $('select[name="end_time_minute"]').val();
	
	// Set min end date == start date
	$('input[name="end_date"]').on('focusin', function(e) {
		$('input[name="end_date"]').datepicker('option', 'minDate', start_date);
	});
	...
	$('select[name="start_time_hour"]').on('change', function(e) {
		if (end_date <= start_date) {
			...
			if (start_hour > end_hour) {
				$('select[name="end_time_hour"]').val(start_hour);
				// Also adjust minutes
				$('select[name="end_time_minute"]').val(start_minute);
			}
		}
	});
	$('select[name="end_time_hour"]').on('change', function(e) {
		if (end_date <= start_date) {
			...
			if (start_hour > end_hour) {
				$('select[name="end_time_hour"]').val(start_hour);
				// Also adjust minutes
				if (start_minute > $('select[name="end_time_minute"]').val()) {
					$('select[name="end_time_minute"]').val(start_minute);
				}
			}
		}
