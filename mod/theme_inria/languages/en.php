...
',
	...
	'theme_inria:groups:discover:tooltip' => "Groups to be discovered, filed by themes",
	...
	'workspace:title:current' => "Workspace actuel&nbsp;: %s",
	...
	'theme_inria:activity_filter:blog' => "Derniers subjects publiés",
	...
	'workspace:back' => "Retour à l'workspace",
	...
	// Workspaces
	'workspace:groups:add' => "Créer un nouvel workspace",
	'theme_inria:workspace:groups:add' => "Créer un nouvel workspace",
	'workspace:groups:edit' => "Modifier l'workspace",
	'workspace:groups:settings' => "Paramètres de l'workspace",
	'workspace:groups:invite' => "Inviter des membres",
	'workspace:groups:name' => "Nom de l'workspace",
	...
	'workspace:groups:banner' => "Image d'entête de l'workspace (ne rien sélectionner pour laisser inchangé)",
	'workspace:groups:about' => "A propos de l'workspace",
	'workspace:groups:icon:inline' => "Image de l'workspace<br />(mini 200x200)",
	'workspace:groups:banner:inline' => "Image de couverture<br />(mini 1200x200)",
	'workspace:theme_inria:group:delete' => "Supprimer l'workspace",
	'workspace:groups:delete' => "Supprimer l'workspace",
	...
	'workspace:groups:leave:confirm' => "Si vous confirmez, vous ne serez plus membre de l'workspace",
	'workspace:groups:leave' => "Quitter cet workspace",
	'workspace:groups:join' => "Rejoindre cet workspace",
	'workspace:groups:joinrequest' => "Demander à rejoindre cet workspace",
	'workspace:theme_inria:ownmembership' => "Adhésion à cet workspace",
	...
	'theme_inria:workspace:notmember' => "Pour participer, rejoignez cet workspace !",
	...
	'workspace:theme_inria:group:archive' => "Archiver l'workspace",
	'workspace:theme_inria:group:archive:details' => "L'archivage d'un workspace permet de rendre cet espace ainsi que l'ensemble de ses contenus inaccessibles pour tous les membres. La différence avec la suppression de l'workspace est que l'workspace et ses contenus peuvent être restaurés par un administrateur.",
	'workspace:groups_archive:archive' => "Archiver l'workspace",
	'workspace:groups_archive:confirm' => "Attention, ceci rendra cet workspace et tous ses contenus inaccessibles pour tous les membres !",
