...
return array(
	...
	'theme_inria:access:groups' => "Visibilité",
	...
	'theme_inria:bookmarklet:description:intro' => "Saviez-vous que vous pouvez ajouter ces liens directement depuis votre navigateur lorsque vous naviguez sur une page ?",
	...
	'loginusername' => "Adresse de courriel",
	'user:password:text' => "Pour générer un nouveau mot de passe, entrez l'adresse de courriel à laquelle vous a été envoyée l'invitation, puis cliquez sur le bouton.",
	...
	'groups:tools:blog:details' => "pour  raconter ou annoncer au jour le jour…l’actualité  / un projet",
	'groups:tools:bookmarks:details' => "pour partager avec son groupe des sites ou pages web de référence, faire profiter d'une veille sur un sujet",
	'groups:tools:event_calendar:details' => "pour partager un calendrier, des échéances, les rendez-vous de votre groupe",
	'groups:tools:file:details' => "",
	'groups:tools:forum:details' => "pour échanger des avis, des infos, des questions/réponses",
	'groups:tools:group_chat:details' => "pour échanger en temps réel avec les membres de son groupe",
	'groups:tools:newsletter:details' => "pour envoyer de temps en temps un récapitulatif des dernières informations du groupe, au groupe ou à d'autres personnes. Contactez Anne Brès si vous souhaitez utiliser cet outil.",
	'groups:tools:pages:details' => "pour construire (surtout à plusieurs) une doc partagée, un référentiel",
	'groups:tools:poll:details' => "pour sonder très rapidement votre communauté sur une seule question à choix unique. Permet de visualiser rapidement les réponses données.",
	'groups:tools:rssimport_blog:details' => "",
	'groups:tools:rssimport_bookmarks:details' => "",
	'groups:tools:subgroups:details' => "un sous-groupe peut être pertinent pour regrouper les échanges de quelques personnes du groupe sur un sujet qui n'intéresse pas tout le groupe. Souhaitez-vous pouvoir en créer ?",
	'groups:tools:subgroups_members_create:details' => "(si non, seuls les responsables du groupe pourront créer des sous-groupes)",
	'groups:tools:survey:details' => "",
	'groups:tools:tasks:details' => "",
	'groups:tools:thewire:details' => "pour partager de très courtes nouvelles (140 car), faire des rappels, signaler des mises à jour",
	...
	'theme_inria:useradd' => "Création d'un compte Invité-e",
	'theme_inria:useradd:details' => "<p>En tant que membre \"%s\", vous avez la possibilité de donner un accès à Iris à une personne qui ne dispose pas de compte Inria.</p><p>Pour cela, renseignez le formulaire ci-dessous, puis cliquez sur le bouton de confirmation pour créer le compte. Une fois le nouveau membre validé par un administrateur, il sera automatiquement mis en contact avec vous.</p><p>Attention : ce compte aura accès à tous les contenus accessibles aux membres d'Iris, aussi veuillez vérifier que l'accès que vous créez respecte bien les critères d'admission définis dans la Charte ! &nbsp; Tout compte qui ne respecte pas la Charte d'utilisation peut être désactivé par un administrateur.</p><p>Pour toutes questions, contactez <a href=\"mailto:aide-iris@inria.fr\">aide-iris@inria.fr</a></p>",
...
",
	...
	'theme_inria:ldapprofile:updatelink' => "Plus à jour ? Veuillez contacter le <a href=\"https://intranet.inria.fr/Vie-pratique/Outils-et-services-numeriques/Assistance/Demande-d-assistance\">SIC de votre centre</a>",
...
',
	...
	'groups:operators_edit_only' => "Réserver l'édition des contenus au(x) responsable(s) de groupe",
 ...
 - Fermé &rarr; <strong>%s</strong>",
	...
	'theme_inria:workspace:invite:parent_members:title' => "Inviter ou inscrire tous les membres du groupe",
	'theme_inria:workspace:invite:parent_members' => "Inviter tous les membres du groupe",
	'theme_inria:workspace:invite:parent_members:details' => "Vous pouvez inviter, ou directement inscrire dans cet espace de travail les %s membres du groupe parent \"%s\".",
	'theme_inria:workspace:invite_parent_members:invalidgroups' => "Invitation/inscription impossible&nbsp;: groupe non valide.",
	'theme_inria:workspace:invite_parent_members:errors' => "Des erreurs se sont produites lors de l'invitation des membres du groupe parent&nbsp;: %s sur %s n'ont pas pu être invités.",
	'theme_inria:workspace:register_parent_members:errors' => "Des erreurs se sont produites lors de l'inscription des membres du groupe parent&nbsp;: %s sur %s n'ont pas pu être inscrits.",
...
%s",
	...
	'transalgo:login:details' => "<p>TransAlgo rassemble une large communauté de scientifiques et des partenaires. L'objectif: pousser la réflexion de manière pluridisciplinaire et interdisciplinaire afin d'évaluer la responsabilité et la transparence des systèmes algorithmiques.<br />Qui planche sur quoi&nbsp;? Découvrez les groupes de travail, les thématiques associées.</p><p><strong>N'hésitez pas à participer au forum de discussion TransAlgo&nbsp;!</strong></p><p><strong>L'inscription se fait sur invitation, après avoir manifesté votre intérêt via le <a href=\"https://transalgo.org/participer-au-forum-scientifique/\">formulaire sur transalgo.org</a>.</strong></p>",
