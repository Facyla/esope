...
echo '<a style="float:right" class="elgg-button elgg-button-action" href="' . $vars['url'] . 'file/owner/' . $user->username . '">Mes images et fichiers</a>';
echo '<a class="elgg-button elgg-button-action" href="' . $vars['url'] . 'blog/owner/' . $user->username . '">Mes articles</a><br /><br />';
