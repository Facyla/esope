...
// Adaptations pour Compétences numériques : pas de wiki perso donc menu filter inutile
//if (elgg_in_context('pages') || ($context == 'pages')) {
if (in_array($context, array('pages', 'blog', 'file'))) {
	return;
}
