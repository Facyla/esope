<?php
/* Usage and security issue
 * For best security, it is recommended to keep this file unusable
 * When you need it :
 *  1. please comment the exit; line below
 *  2. use at yourserver/mysql_adminer.php
 * Once done, please uncomment the line again : exit;
 */
exit;
